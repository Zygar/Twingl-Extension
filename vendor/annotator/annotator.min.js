...
Annotator = (function(_super) {
  ...
  Annotator.prototype.onAdderClick = function(event) {
    ...
    $(annotation.highlights).addClass('annotator-hl-temporary').removeClass('annotator-hl');
    save = function() {
      cleanup();
      $(annotation.highlights).removeClass('annotator-hl-temporary').addClass('annotator-hl');
